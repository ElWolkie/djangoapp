...
ALLOWED_HOSTS = ["localhost", "127.0.0.1", "192.168.250.7", "192.168.0.103", "10.52.13.73", '192.168.0.1', '192.168.0.106', '192.168.0.105', '0.0.0.0', config("SERVER", default="127.0.0.1")]
