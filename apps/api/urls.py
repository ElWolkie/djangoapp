...
urlpatterns = [
    ...
    path('pagos/test-simple/', test_pago_simple, name='test_pago_simple'),
     path('pagos/diagnostico/', diagnostico_pago, name='diagnostico_pago'),
